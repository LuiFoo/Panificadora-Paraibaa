...
function Header() {
  ...
  return (
    <header className="bg-white rounded-lg shadow-lg relative p-8 flex justify-center items-center font-bold text-sm">
      {/* Botão menu (mobile) */}
      <button
        className="block md:hidden absolute left-5 top-5 z-20"
      ...
      {/* Menu Desktop */}
      <nav className="hidden md:flex justify-center items-center gap-5 w-full">

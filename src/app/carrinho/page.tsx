              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="bg-green-600 hover:bg-green-500 disabled:bg-gray-400 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                    {atualizandoPrecos ? (
                      <>

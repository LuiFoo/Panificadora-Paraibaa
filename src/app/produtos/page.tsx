              ...
              {itens.length ? (
                itens.map((item) => (
                  ...
                  >
                    ...
                    <Link
                      href={`/item/${categoriaAtual.toLowerCase().replace(/\s+/g, "-")}/${item._id}`}
                      className="font-semibold bg-amber-600 hover:bg-amber-500 text-white px-4 py-2 rounded-lg block text-center"
                    >
                      Ver opções
                    </Link>
                  </div>
